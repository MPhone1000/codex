...
```bash
gh workflow run internal-rust-release.yml --ref candidate/queue/rust-vX.Y.Z -R SDGLBL/codex -f upstream_tag=rust-vX.Y.Z -f release_ref=candidate/queue/rust-vX.Y.Z -f internal_tag=internal-rust-vX.Y.Z -f publish=true
```

仅进行空跑捆绑：

```bash
gh workflow run internal-rust-release.yml --ref candidate/queue/rust-vX.Y.Z -R SDGLBL/codex -f upstream_tag=rust-vX.Y.Z -f release_ref=candidate/queue/rust-vX.Y.Z -f internal_tag=internal-rust-vX.Y.Z-dryrun -f publish=false
```
