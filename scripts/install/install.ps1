...
function Get-ReleaseUrl {
    ...
    return "https://github.com/MPhone1000/codex/releases/download/internal-rust-v$ResolvedVersion/$AssetName"
}
...
function Resolve-Version {
    ...
    $release = Invoke-RestMethod -Uri "https://api.github.com/repos/MPhone1000/codex/releases/latest"
